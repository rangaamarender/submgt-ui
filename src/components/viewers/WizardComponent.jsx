    ...
    return (
        ...
        >
            <div className="h-screen">
                <div
                    style={{ height: '10vh' }}
                    className={`w-75 fixed overflow-hidden top-0 bg-light ${scrollPosition > 0 && 'boxShadow'} `}
                >
                ...
                <div className="surface-border border-round ">
                    <div>
                        ...
                        <div className="fixed bottom-0 right-0  w-75 h-custom-10  p-sidebar-header bg-light">
